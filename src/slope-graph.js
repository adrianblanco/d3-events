...
function ready(datapoints) {
  ...
  svg
    ...
    .on('mouseover', function(d) {
      svg.select('path.' + d.state).attr('stroke', 'pink')
      svg.selectAll('circle.' + d.state)
        .attr('fill', 'pink')
      svg.select('text.' + d.state).attr('fill', 'pink')
    })
    .on('mouseout', function(d) {
      svg
        .selectAll('path.' + d.state)
        .transition()
        .attr('stroke', colorScale(d.state))
      svg
        .selectAll('circle.' + d.state)
        .transition()
  ...
  svg
    ...
    //mouseover and mouseout functions
    .on('mouseover', function(d) {
      svg.select('path.' + d.key).attr('stroke', 'pink')
      svg.selectAll('circle.' + d.key).attr('fill', 'pink')
      svg.select('text.' + d.key).attr('fill', 'pink')
    })
    .on('mouseout', function(d) {
      svg
